...
// import dataJSON from '../../admin/data/data.json';
...
//       rating: string;
//       delta_rating: number;
//       [para: string]: number | string; // Allow both number and string values
//     };
//   }

//   const dataJSONTyped: DataJSON = dataJSON;
...
//       Object.keys(dataJSONTyped).map((id:string)=>
//       {
//         const valueToCompare = dataJSONTyped[id][para];
//         const condition = alertSetting.criterion === '0' && typeof valueToCompare === 'number'
//             ? value <= -1 * valueToCompare
//             : (alertSetting.criterion === '1' || alertSetting.criterion === '3') && typeof valueToCompare === 'number'
//             ? value >= valueToCompare
//             : alertSetting.criterion === '2' && typeof valueToCompare === 'number'
//             ? value <= valueToCompare
//             : value === valueToCompare;

//         const realValue = alertSetting.criterion === '0' && typeof dataJSONTyped[id][para] === 'number'
//         ? dataJSONTyped[id][para] * -1
//         : dataJSONTyped[id][para];
...
//         const condition = alertSetting.criterion === '0' && typeof dataJSONTyped[id][para] === 'number'
//             ? value >= -1 * dataJSONTyped[id][para]
//             : (alertSetting.criterion === '1' || alertSetting.criterion === '3') && typeof dataJSONTyped[id][para] === 'number'
//             ? value >= dataJSONTyped[id][para]
//             : alertSetting.criterion === '2' && typeof dataJSONTyped[id][para] === 'number'
//             ? value <= dataJSONTyped[id][para]
//             : value == dataJSONTyped[id][para];
